(ns com.left-over.common.services.db.entities
  (:require
    [com.left-over.common.services.db.entities.core :as ent])
  (:require-macros
    [com.left-over.common.services.db.entities]))

(def locations (com.left-over.common.services.db.entities/loaded-locations))
(def shows (com.left-over.common.services.db.entities/loaded-shows))
(def users (com.left-over.common.services.db.entities/loaded-users))
